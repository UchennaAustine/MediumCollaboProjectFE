...
const GetStarted = () => {
  return (
    <div className="w-full h-[100vh] flex items-center justify-center">
        ...
        <div className="w-[50%] px-[20px] py-[50px] bg-white shadow-2xl flex items-center justify-center flex-col relative">
        <Link to="/">
        <button className='w-[40px] h-[40px] shadow flex items-center justify-center text-red-500 text-[20px] absolute top-0 left-0 cursor-pointer'><BsArrowLeft/></button>
        </Link>
